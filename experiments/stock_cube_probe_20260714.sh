...
RUN_ID=stock_cube_probe_20260714
ROOT="$BASE/$RUN_ID"
...
SOURCE_CACHE="$JEPA_WT/experiments/scripts/stock_cube_probe_cache_20260714.py"
SOURCE_LAUNCHER="$JEPA_WT/experiments/stock_cube_probe_20260714.sh"
...
EXPECTED_ANALYZER_SHA256=83eeddb245405df1106a5f2b0cc87052f69d829006ce3de0dcc1c4174f35143c

DATASET="$BASE/datasets/ogbench/cube_single_expert.h5"
CELLS=(
  c1_linear_pure
  c2_linear_hybrid_l05
  c3_mlp_hybrid_l05
  c4_mlp_pure
)
CELLS_JSON='["c1_linear_pure","c2_linear_hybrid_l05","c3_mlp_hybrid_l05","c4_mlp_pure"]'
...
CACHE="$PROV/stock_cube_probe_cache_20260714.py"
LAUNCHER="$PROV/stock_cube_probe_20260714.sh"
...
cell_gpu() {
  case "$1" in
    c1_linear_pure) echo 0 ;;
    c2_linear_hybrid_l05) echo 1 ;;
    c3_mlp_hybrid_l05) echo 2 ;;
    c4_mlp_pure) echo 3 ;;
    *) die "unknown cell: $1" ;;
  esac
}
...
usage() {
  cat <<'EOF'
usage: stock_cube_probe_20260714.sh COMMAND
