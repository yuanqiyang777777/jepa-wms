...
SOURCE_CACHE="$JEPA_WT/experiments/scripts/stock_cube_lambda_sweep_mlp_cache_20260715.py"
SOURCE_LAUNCHER="$JEPA_WT/experiments/stock_cube_lambda_sweep_mlp_20260715.sh"
...
CELLS_JSON='["m1_mlp_l03","m2_mlp_l04","m3_mlp_l06","m4_mlp_l07"]'
...
CACHE="$PROV/stock_cube_lambda_sweep_mlp_cache_20260715.py"
LAUNCHER="$PROV/stock_cube_lambda_sweep_mlp_20260715.sh"
...
usage() {
  cat <<'EOF'
usage: stock_cube_lambda_sweep_mlp_20260715.sh COMMAND
