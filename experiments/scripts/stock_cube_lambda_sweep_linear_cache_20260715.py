...
EXPLORATORY stock-Cube lambda-transfer sweep (linear family).  No probe is ever
...
CELL_SPECS: dict[str, dict[str, Any]] = {
    "l1_linear_l03": {"family": "s0", "hybrid_lambda": 0.3, "mode": "hybrid"},
    "l2_linear_l04": {"family": "s0", "hybrid_lambda": 0.4, "mode": "hybrid"},
    "l3_linear_l06": {"family": "s0", "hybrid_lambda": 0.6, "mode": "hybrid"},
    "l4_linear_l07": {"family": "s0", "hybrid_lambda": 0.7, "mode": "hybrid"},
}
